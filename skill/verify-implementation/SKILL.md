...
description: Guidelines to verify code implementation after a task is done
---

When verifying an implementation, follow steps below.

<verification-guidelines>

# Verification guidelines

- Gather context - use conversation history, `git status`
- do *preflight checks* - do linting, formatting, type checking as required
