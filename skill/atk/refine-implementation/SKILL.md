...
2. Review and address repeatedly
   - Ask @general-alpha and @general-beta agents to use `$review-changes` skill. Ask it to review the change set, giving the command to list the changes (eg, `git diff --cached`).
